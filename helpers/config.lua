...
-- CTRL + S ALSO IN INSERT MODE
lvim.keys.insert_mode["<C-s>"] = "<Esc>:w<cr>li"
-- CTRL + A TO SELECT ALL
lvim.keys.normal_mode["<C-a>"] = "<Esc>ggVG"
-- CTRL + / TO CLEAR SEARCH
lvim.keys.normal_mode["<C-/>"] = "<Esc>:noh<cr>"
...
-- Remove LSP tab mapping, because it conflicts with Copilot.
lvim.builtin.cmp.mapping["<Tab>"] = nil
-- lvim.builtin.cmp.mapping["<S-Tab>"] = nil
lvim.builtin.dap.active = true

lvim.keys.normal_mode["<C-p>"] = ":TroubleToggle<CR>"

-- alt-h/l to move between buffers
